...
object FontStyles {
    ...
    fun textStyleTitleLarge(backgroundHsl: FloatArray) = MyTypography.titleLarge.copy(
    ...
    fun textStyleTitleMedium(backgroundHsl: FloatArray) = MyTypography.titleMedium.copy(
        color = deriveTextColor(backgroundHsl),
        shadow = Shadow(
            color = Color.Black,
            offset = Offset(0f, 2f),
    ...
    fun textStyleBodyLarge(backgroundHsl: FloatArray) = MyTypography.bodyLarge.copy(
        color = deriveTextColor(backgroundHsl),
        shadow = Shadow(
            color = Color.Black,
            offset = Offset(0f, 2f),
    ...
    fun textStyleDisplayMedium(backgroundHsl: FloatArray) = MyTypography.displayMedium.copy(
        color = deriveTextColor(backgroundHsl),
        shadow = Shadow(
            color = Color.Black,
            offset = Offset(0f, 2f),
    ...
    private fun deriveTextColor(backgroundHsl: FloatArray): Color {
        var textColor: Color = if (backgroundHsl[2] > 0.5f) {
            Color.Black
        } else {
            Color.White
        }
